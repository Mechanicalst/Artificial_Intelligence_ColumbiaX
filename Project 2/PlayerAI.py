...
#defining Eval
	def Eval(cur_node):
        grid = cur_node.grid
	#Here, we can see that 2,-2,10,3,1:512,512,256, is probably the ultimate combo
	#and also snake 12 is decent  

	#again similarly, 8,-4,10,5,2 : 1024, 256, are the good combo with 
	#theMerger being set to 3 512--128. 
    ...
    # in order to give us the total function
